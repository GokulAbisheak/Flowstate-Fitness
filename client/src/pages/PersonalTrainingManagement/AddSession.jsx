...
import { Grid, Select, FormControl, Box, useTheme } from '@mui/material';
...
function AddSession() {
  ...
  return (
    <Box sx={{backgroundColor: theme.palette.background.alt, maxWidth: '600px', margin: '100px auto', padding: '20px', boxShadow: '0px 0px 5px #000000'}}>
